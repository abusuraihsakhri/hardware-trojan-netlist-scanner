"""
Data Models & Telemetry Definitions for Gate-Level Netlist Hardware Trojan & Stealth Payload Scanner.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "Trust-HUB Hardware Trojan Taxonomy"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
