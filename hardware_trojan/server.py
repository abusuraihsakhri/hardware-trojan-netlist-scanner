"""
FastAPI REST API Server for Gate-Level Netlist Hardware Trojan & Stealth Payload Scanner.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="Gate-Level Netlist Hardware Trojan & Stealth Payload Scanner",
            description="Analyzes ASIC/FPGA gate netlists for rare trigger activation probabilities, ring-oscillator anomalies, and kill-switch payloads.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "hardware-trojan-netlist-scanner", "domain": "Hardware Security", "version": "2.0.0-FRONTIER"}
