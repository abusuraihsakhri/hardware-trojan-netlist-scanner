"""
Command Line Interface for Hardware Trojan Netlist Scanner.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="hardware-trojan-netlist-scanner", description="Hardware Trojan Netlist Scanner")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  HARDWARE TROJAN NETLIST SCANNER")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Hardware Trojan Netlist Scanner Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Hardware Trojan Netlist Scanner API server on http://{args.host}:{args.port}")
