...
import pytest
from hardware_trojan.models import FrontierPayload, ExecutionStatus
from hardware_trojan.engine import FrontierDomainEngine
from hardware_trojan.agents import RareEventTransitionAgent, CombinationalLoopScannerAgent, StealthPayloadClassifierAgent, TrojanScannerCoordinator
from hardware_trojan.cli import main


def test_sub_agents():
    a1 = RareEventTransitionAgent()
    ...
    a2 = CombinationalLoopScannerAgent()
    ...
    a3 = StealthPayloadClassifierAgent()
...
def test_coordinator():
    coord = TrojanScannerCoordinator()
    ...
    assert "Trust-HUB Hardware Trojan Taxonomy" in ans or "specifications" in ans
